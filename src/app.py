...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practicing skills, tactics, and teamwork",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skill development, pickup games, and intramural play",
    ...
    "Debate Team": {
        "description": "Practice public speaking, argumentation, and tournament preparation",
